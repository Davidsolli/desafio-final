...
/// - Aluno destinatário (usa o próprio ID por padrão)
/// - Exercícios (com nome, grupo muscular, séries, reps, carga, descanso)
class CreateWorkoutSheetDialog extends StatefulWidget {
  const CreateWorkoutSheetDialog({super.key});

  @override
  State<CreateWorkoutSheetDialog> createState() => _CreateWorkoutSheetDialogState();
}
  ...
  Future<void> _submit() async {
    ...
    final exerciseDTOs = _exercises.asMap().entries.map((entry) {
      ...
      return ExerciseCreateDTO(
        ...
        loadKg: double.tryParse(e.loadController.text) ?? 0.0,
        restSeconds: int.tryParse(e.restController.text) ?? 60,
        observations: e.obsController.text.isEmpty ? null : e.obsController.text.trim(),
        order: i + 1,
      );
    }).toList();
    ...
    try {
      ...
      if (mounted) {
        _showError('Erro ao criar ficha: ${e.toString()}');
      }
    } finally {
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      TextFormField(
                        ...
                        decoration: _inputDecoration('Ex: Treino A — Peito + Tríceps'),
                        validator: (v) =>
                      ...
                      TextFormField(
                        ...
                        decoration: _inputDecoration('Observações sobre o treino...'),
                        maxLines: 2,
                      ),
                      const SizedBox(height: 12),
                      ...
                      DropdownButtonFormField<int>(
                        ...
                        onChanged: (v) => setState(() => _selectedDayOfWeek = v ?? 0),
                      ),
      ...
      child: Column(
        ...
        children: [
          ...
          DropdownButtonFormField<String>(
            initialValue: entry.selectedMuscleGroup,
            ...
            onChanged: (v) => setState(() => entry.selectedMuscleGroup = v ?? validMuscleGroups.first),
          ),
          const SizedBox(height: 8),
            ...
            children: [
              Expanded(
                child: TextFormField(
                  ...
                  decoration: _inputDecoration(null).copyWith(labelText: 'Séries'),
              ...
              Expanded(
                child: TextFormField(
                  ...
                  keyboardType: TextInputType.number,
                  decoration: _inputDecoration(null).copyWith(labelText: 'Reps'),
                  validator: (v) => v == null || v.isEmpty ? 'Req.' : null,
                ),
              ),
              const SizedBox(width: 8),
              Expanded(
                child: TextFormField(
                  ...
                  decoration: _inputDecoration(null).copyWith(labelText: 'Carga (kg)'),
                  validator: (v) => v == null || v.isEmpty ? 'Req.' : null,
                ),
              ),
            ],
          ...
          TextFormField(
            ...
            keyboardType: TextInputType.number,
            decoration: _inputDecoration(null).copyWith(labelText: 'Descanso (segundos)'),
          ),
          const SizedBox(height: 8),
...
/// Modelo interno para cada exercício no formulário.
class _ExerciseFormEntry {
  ...
  final loadController = TextEditingController(text: '0');
  final restController = TextEditingController(text: '60');
  final obsController = TextEditingController();
  String selectedMuscleGroup = validMuscleGroups.first;
