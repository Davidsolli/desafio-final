...
class LogbookService:
    ...
    async def create_session(
        ...
        session_obj = WorkoutSession(
            ...
            status="completed" if dto.workout_name else "in_progress",
    ...
    def _to_session_response(session_obj: WorkoutSession) -> SessionResponseDTO:
        ...
        return SessionResponseDTO(
            ...
            workout_name=session_obj.workout_name,
            duration_minutes=session_obj.duration_minutes,
            calories_burned=session_obj.calories_burned,
            intensity=session_obj.intensity,
